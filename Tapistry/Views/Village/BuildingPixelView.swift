...
private enum Sprites {
    ...
    /// Iso fence: two vertical posts (cols 4 and 20) with two rails sloping -0.5
    /// up-right between them, matching the grass block's right-face iso direction.
    /// Post 2 (upper-right, col 20) sits 8 rows above post 1 (lower-left, col 4).
